...
#################################################################################################
  def self.time_schedule_parser(url)
    ...
    Category.create(:name=>"Spanish Linguistics", :abbrev=>"SPLIG", :url=>"spanlin.html", :parent_id=>top_category.id)
    ...
    Category.create(:name=>"Ophthalmology", :abbrev=>"OPTHP", :url=>"ophthal.html", :parent_id=>college.id)
